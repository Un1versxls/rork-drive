  ...
  return (
    <View style={styles.root}>
      <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
        {fromUpgrade ? (
          <Pressable onPress={onBack} hitSlop={16} style={styles.closeBtn} testID="paywall-close">
            <Text style={styles.closeText}>✕</Text>
          </Pressable>
        ) : (
          <Pressable onPress={onBack} hitSlop={16} style={styles.backBtn} testID="paywall-back">
...
const styles = StyleSheet.create({
  ...
  backBtn: { alignSelf: "flex-start", width: 36, height: 36, alignItems: "center", justifyContent: "center", marginTop: 4, borderRadius: 18 },
  ...
  planCardEyebrow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 6 },
  planCardEyebrowText: { color: Colors.accentDeep, fontSize: 10, fontWeight: "900", letterSpacing: 1.4 },
  planCardName: { color: Colors.text, fontSize: 18, fontWeight: "900", letterSpacing: -0.3 },
  planCardTag: { color: Colors.textDim, fontSize: 12, fontWeight: "600", marginTop: 2 },

  eyebrow: { color: Colors.accentGold, letterSpacing: 3, fontWeight: "900", fontSize: 11, marginTop: 2 },
  title: { color: Colors.text, fontSize: 32, fontWeight: "900", letterSpacing: -0.8, marginTop: 8, lineHeight: 38 },
